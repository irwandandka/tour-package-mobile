...
type TermConditionNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  "TermCondition"
>;
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.paragraph}>
          By booking a tour package with us, you acknowledge that you have read,
          understood, and agree to be bound by these Terms and Conditions. These
          terms apply to all users of our services.
        </Text>

        <Text style={styles.sectionTitle}>2. Booking Policy</Text>
        <Text style={styles.paragraph}>
          All bookings are subject to availability and confirmation. A booking
          will only be considered valid once payment has been received and a
          confirmation email has been sent. Customers must provide accurate and
          complete personal information during the booking process.
        </Text>

        <Text style={styles.sectionTitle}>3. Payment Terms</Text>
        <Text style={styles.paragraph}>
          Full payment must be made at the time of booking unless otherwise
          stated. We accept payments through authorized methods listed on our
          platform. Prices are subject to change without prior notice.
        </Text>
        ...
        <Text style={styles.paragraph}>
          Travelers are responsible for obtaining valid passports, visas, and
          complying with local laws. We are not liable for issues arising due to
          incomplete travel documents or violations of local regulations.
        </Text>

        <Text style={styles.sectionTitle}>6. Liability</Text>
        <Text style={styles.paragraph}>
          We are not liable for delays, cancellations, accidents, or losses
          caused by third parties, natural disasters, or unforeseen
          circumstances beyond our control. Customers are strongly advised to
        ...
        <Text style={styles.paragraph}>
          ...
          shall be resolved under the exclusive jurisdiction of the courts in
          Indonesia.
        </Text>

        <Text style={styles.paragraph}>
          By clicking "I Agree", you acknowledge that you have read and accepted
          all the terms outlined above.
        </Text>
      </ScrollView>
